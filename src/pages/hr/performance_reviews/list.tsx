...
export const PerformanceReviewList = () => {
  ...
  useEffect(() => {
    document.title = translate("pages.performance_reviews.list.title");
  }) 
  ...
  return (
    <List
      ...
      headerButtons={
          <Space>
            <Button icon={<PlusOutlined/>} size="large" onClick={() => navigate("/hr/performance_reviews/create")} disabled={!permissions?.includes("CREATE:PERFORMANCE_REVIEWS")}>
