...
import { useExport, useImport, usePermissions, useTranslation } from "@refinedev/core";
...
export const DepartmentList = () => {
  ...
  return (
    <List
      ...
      headerButtons={
          <Space>
            <Button icon={<PlusOutlined/>} size="large" onClick={() => navigate("/hr/departments/create")} disabled={!permissions?.includes("CREATE:DEPARTMENTS")}>
